...
%The title page is first created.
  TOWARD GRAVITATIONAL WAVEFORMS FOR EXTREME AND INTERMEDIATE MASS RATIO INSPIRALS OF BLACK HOLE BINARY SYSTEMS: STRATEGIES FOR COMPUTING THE SELF-FORCE OF A SCALAR FIELD ON A SCHWARZSCHILD SPACETIME BACKGROUD USING THE DISCONTINUOUS GALERKIN, EFFECTIVE SOURCE, AND OSCULATING ORBIT METHODS
